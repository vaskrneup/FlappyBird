...
export class Bird {
    constructor(x, y, acceleration, downFlapImage, midFlapImage, upFlapImage, jumpLenPerClick) {
        ...
        this._jumpLenPerClick = jumpLenPerClick;
    ...
    reset = () => {
        this.x = this._x || ~~(GAME_BACKGROUND_IMG_WIDTH / 6);
        this.y = this._y || ~~(GAME_BACKGROUND_IMG_HEIGHT / 2);
        this.acceleration = this._acceleration || ACCELERATION;
